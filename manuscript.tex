...
\affiliation[affiliationB]{organization={Shibaura Institute of Technology},
            city={Tokyo},
            country={Japan}}
...
\hline\noalign{\smallskip}
\multicolumn{1}{p{2cm}|}{\centering Strategy I  \\ (Fig. \ref{fig:segments} b))} 
& \multicolumn{1}{p{2cm}|}{\centering Strategy II  \\ (Fig. \ref{fig:segments} c))}  
& $w_{\rm{CH_4}}$ 
& $ w_T $ \\
...
The presented work was supported by the Polish National Agency for Academic Exchange (NAWA), within the Strategic Partnerships Program, Project No. BPI/PST/2021/1/00023 and partially supported by the program "Excellence Initiative – Research University" for the AGH University of Science and Technology.
